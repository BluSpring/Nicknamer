...
class PronounsProfileGetNameCommand<T : FabricClientCommandSource> : Command<T> {
    override fun run(context: CommandContext<T>): Int {
        ...
        val profile = PronounManager.pronounProfiles[playerUUID]!!.profiles[profileName]!!

        context.source.sendFeedback(
            Text.literal("Pronouns profile $profileName for $playerName has the pronouns ")
